            ...
            <li class="nav-item nav-dropdown">
                                ...
                                <ul class="nav-dropdown-items">
                                    <li class="nav-item ml-3">
                                        <a href="\projeto/model/sup/ocorr_alu/lista_ocorr_alu.php" class="nav-link <?php if($page=='ocorr_alu'){echo'active';} ?>"><i class="far fa-exclamation-circle"></i> Ocorrências de alunos</a>
                                    </li>
                                    <li class="nav-item ml-3">
