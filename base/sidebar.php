<div class="sidebar">
                    <nav class="sidebar-nav">
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a href="\projeto/model/turma/lista_turma.php" class="nav-link"><i class="fa fa-users-class"></i> Turmas</a>
                            </li>
                            <li class="nav-item nav-dropdown">
                                <a href="" class="nav-link nav-dropdown-toggle">
                                    <i class="fa fa-chalkboard-teacher"></i> Funcionários <i class="fa fa-caret-left"></i>
                                </a>
                                <ul class="nav-dropdown-items">
                                    <li class="nav-item ml-3">
                            ...
                            <li class="nav-item">
                                <a href="\projeto/model/disciplina/lista_disciplina.php" class="nav-link"><i class="fa fa-books"></i> Disciplinas</a>
                            </li>
                            <li class="nav-item">
                                <a href="\projeto/model/sala/lista_sala.php" class="nav-link"><i class="fa fa-door-closed"></i> Salas</a>
                            </li>
                            <li class="nav-item">
                                <a href="\projeto/model/ue/lista_ue.php" class="nav-link"><i class="fa fa-school"></i> Unidades Escolares</a>
                            </li>
                            <li class="nav-item">
                                <a href="\projeto/model/responsavel/lista_responsavel.php" class="nav-link"><i class="fa fa-user-friends"></i> Responsáveis</a>
                            </li>
                            <li class="nav-item">
                                <a href="\projeto/model/nota/lanca_nota.php" class="nav-link"><i class="fa fa-th-list"></i> Lançamento de notas</a>
                            </li>
                            <li class="nav-item nav-dropdown">
                                <a href="" class="nav-link nav-dropdown-toggle">
                                    <i class="fa fa-user"></i> Usuários <i class="fa fa-caret-left"></i>
                                </a>
                                <ul class="nav-dropdown-items">
                                    <li class="nav-item ml-3">
                                        <a href="\projeto/model/usuario/lista_usuario.php" class="nav-link"><i class="fa fa-user"></i> Listar Usuários</a>
                                    </li>
                                    <li class="nav-item ml-3">
                                        <a href="layouts-fixed-sidebar.html" class="nav-link"><i class="fa fa-list-ul"></i> Lista de Atividades</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
