...
$sql = mysqli_query($conexao, "select * from usuario where nome_usu like '%".$valor."%' or usuario like '%".$valor."%' order by nome_usu asc limit $inicio, $quantidade"); // Procura titulos no banco relacionados ao valor
