                        ...
                        <div class="card">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="submit" onclick="searchTurma(this.value)" class="btn btn-primary"><i class="fa fa-search"></i>&nbsp; Pesquisar</button>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="view/cadastrar_turma.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp; Adicionar</button></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php include "messages.php"; ?>
                                <div id="table-list" class="table-responsive">
                                    <table cellpadding="20" id="tabela_turma" class="table table-sm tablesorter">
                                        <thead>
                                            <tr>
                                                <th scope="col">ID&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                        ...
                                        <?php
                                            ...
                                            $data = mysql_query("select * from turma order by numero asc limit $inicio, $quantidade;") or die(mysql_error());
                                            ...
                                            while($info = mysql_fetch_array($data)){ //Transforma o conteúdo da variável $data em um array na variável $info;
                                                ...
                                                echo "<td><div class='btn-group btn-group-sm' role='group'>
                                                            ...
                                                            <a class='btn btn-success' href=view/cadastrar_disc_pdr.php?id_turma=".$info['id_turma']."><i class='fa fa-list-ul'></i>&nbsp; Disciplinas</a>
