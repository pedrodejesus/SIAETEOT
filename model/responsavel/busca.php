...
$sql = mysqli_query($conexao, "select * from responsavel where nome_resp like '%".$valor."%' or sobrenome_resp LIKE '%".$valor."%' order by nome_resp asc limit $inicio, $quantidade"); // Procura titulos no banco relacionados ao valor
