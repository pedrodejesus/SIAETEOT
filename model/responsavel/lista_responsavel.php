                        ...
                        <div class="card">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="submit" onclick="searchResp(this.value)" class="btn btn-primary"><i class="fa fa-search"></i>&nbsp; Pesquisar</button>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="view/cadastrar_resp.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp; Adicionar</button></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php include "messages.php"; ?>
                                <div id="table-list" class="table-responsive">
                                    <table cellpadding="20" id="tabela_resp" class="table table-sm tablesorter">
                                        <thead>
                                            <tr>
                                                <th scope="col">ID</th>
                                        ...
                                        <?php
                                            ...
                                            $data = mysql_query("select * from responsavel order by nome_resp asc limit $inicio, $quantidade;") or die(mysql_error());
