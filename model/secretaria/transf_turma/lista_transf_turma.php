            ...
            <div class="content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Transferências de Turma</li>
                    </ol>
                </nav>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-light">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="view/cadastrar_transf_turma.php"><button id='add' type="button" class="btn btn-primary col-sm-12"><i class="fa fa-exchange"></i>&nbsp; Transferir aluno</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="table-list" class="table-responsive">
                                    <table cellpadding="20" id="tabela_alu" class="table table-sm">
                                        ...
                                        <?php
                                            ...
                                            $sql .= "and a.matricula_alu = tt.matricula_alu order by dt_trans desc limit $inicio, $quantidade;";
                                            ...
                                            while($info = mysqli_fetch_array($data)){
                                                ...
                                                echo "<td>".$info['turma_antiga']."</td>";
                                                echo "<td>".$info['turma_nova']."</td>"; 
                                                echo "<td>".implode("/", array_reverse(explode("-", $info['dt_trans'])))."</td>";
                                                echo "<td><div class='btn-group btn-group-sm' role='group'>
                                                            <a class='btn btn-success' href=view/visualizar_transf_turma.php?id_trans=".$info['id_trans']."><i class='fa fa-info-circle'></i>&nbsp; Detalhes</a>
                                                                
                                                            <a class='btn btn-danger' onclick='deletaTransfTurma(".$info['id_trans'].")' data-toggle='modal' href='#delete-modal'><i class='fa fa-trash'></i>&nbsp; Excluir</a>
                                                          </div>
                                                        </td></tr>";
                                            }
                                        ?>
