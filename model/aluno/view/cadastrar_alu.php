                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" size="15" maxlength="256" name="matricula_alu" id="matricula_alu" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" maxlength="30" name="nome_alu" id="nome_alu" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" maxlength="70" name="sobrenome_alu" id="sobrenome_alu" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="cpf_alu" id="cpf_alu" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" maxlength="20" name="rg_alu" id="rg_alu" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="dt_nasc_alu" id="dt_nasc_alu" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
