...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioNivel'] != 1)) { // Verifica se não há a variável da sessão que identifica o usuário
...
<body class="sidebar-fixed header-fixed">
    <div class="page-wrapper">
        ...
        <div class="main-container">
            <?php 
                include "../../../base/sidebar/1_sidebar.php";
