...
foreach($matricula_alu as /*$index =>*/ $matricula){
    ...
    $sql2 = "select distinct tipo_matricula, dt_matricula from matriculado where matricula_alu = ".$matricula." and id_turma = ".$id_turma.";";
    $consulta2 = mysqli_query($conexao, $sql2);
    /*$data_tipo = mysqli_fetch_array($consulta2);
