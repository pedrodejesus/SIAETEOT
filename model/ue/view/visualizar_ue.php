                                    ...
                                    <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for="id_ue" class="form-control-label"><strong>ID</strong></label>
                                                    <p class="form-control-plaintext"><?php echo $row["id_ue"]; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="nome_ue" class="form-control-label"><strong>Nome</strong></label>
                                                    <p class="form-control-plaintext"><?php echo $row["nome_ue"]; ?></p>
                                                </div>
                                            </div>
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="nome_ue" class="form-control-label"><strong>Telefone</strong></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="btn-group" role="group"> 
                                                <?php
                                                    echo "<a class='btn btn-warning' href=editar_ue.php?id_ue=".$row['id_ue']."><i class='fa fa-edit'></i>&nbsp; Editar</a>
                                                                
                                                           <a class='btn btn-danger' href='../controller/exclui_ue.php?id_ue=".$row['id_ue']."'><i class='fa fa-trash'></i>&nbsp; Excluir</a>
