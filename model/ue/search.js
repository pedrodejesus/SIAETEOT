var req;
function searchUe(valor) { // Função para buscar aluno
    ...
    req.onreadystatechange = function() { // Quando o objeto recebe o retorno, chamamos a seguinte função;
        ...
        if(req.readyState == 1) { // Exibe a mensagem "Buscando..." enquanto carrega
            document.getElementById('tbody_ue').innerHTML = 'Buscando...';
        ...
        document.getElementById('tbody_ue').innerHTML = resposta; // Abaixo colocamos a(s) resposta(s) na div resultado
        }
        /*if(!resposta){
