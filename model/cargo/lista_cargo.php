                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" id="busca" onkeyup="searchCargo(this.value)" class="form-control">
                                            <span class="input-group-btn">
                                                <button type="submit" onclick="searchCargo(this.value)" class="btn btn-primary"><i class="fa fa-search"></i>&nbsp; Pesquisar</button>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="view/cadastrar_cargo.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp; Adicionar</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="table-list" class="table-responsive">
                                    <table cellpadding="20" id="tabela_disc" class="table table-sm tablesorter">
                                        ...
                                        <?php
                                            ...
                                            $data = mysql_query("select * from cargo order by id_cargo asc limit $inicio, $quantidade;") or die(mysql_error());
                                    ...
                                    <nav aria-label="Paginação">
                                        <ul class="pagination">
                                        <?php 
                                            $sqlTotal 		= "select id_cargo from cargo;";
