                                    ...
                                    <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for="id_setor" class="form-control-label"><strong>ID</strong></label>
                                                    <p class="form-control-plaintext"><?php echo $row["id_setor"]; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="nome_setor" class="form-control-label"><strong>Nome</strong></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="btn-group" role="group"> 
                                                <?php
                                                    echo "<a class='btn btn-warning' href=editar_setor.php?id_setor=".$row['id_setor']."><i class='fa fa-edit'></i>&nbsp; Editar</a>
                                                                
                                                           <a class='btn btn-danger' href='../controller/exclui_setor.php?id_setor=".$row['id_setor']."'><i class='fa fa-trash'></i>&nbsp; Excluir</a>
