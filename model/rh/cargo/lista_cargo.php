                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="view/cadastrar_cargo.php"><button id='add' type="button" class="btn btn-primary col-sm-12"><i class="fa fa-plus-circle"></i>&nbsp; Adicionar</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="table-list" class="table-responsive">
                                    <table id="tabela_disc" class="table table-sm tablesorter">
                                        ...
                                        <?php
                                            ...
                                            $data = mysqli_query($conexao, "select * from cargo order by id_cargo asc limit $inicio, $quantidade;") or die(mysql_error());
