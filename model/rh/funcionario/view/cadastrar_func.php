                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="id_setor" name="id_setor" class="form-control">
                                                        ...
                                                        <?php
                                                            $data_setor = mysqli_query($conexao, "select * from setor order by nome_setor asc");
                                                            while($info_setor = mysqli_fetch_array($data_setor)){
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="id_cargo" name="id_cargo" class="form-control">
                                                        <option value="0">Selecione</option>
                                                        <?php
                                                            $data_cargo = mysqli_query($conexao, "select * from cargo order by nome_cargo asc");
                                                            while($info_cargo = mysqli_fetch_array($data_cargo)){
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="id_funcao" name="id_funcao" class="form-control">
                                                        <option value="0">Selecione</option>
                                                        <?php
                                                            $data_funcao = mysqli_query($conexao, "select * from funcao order by nome_funcao asc");
                                                            while($info_funcao = mysqli_fetch_array($data_funcao)){
