                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-light">
                                    <h4>Adicionar setor escolar</h4>
                                </div>
                                
                                <div class="card-body">
                                    <form action="../controller/insere_setor.php" method="post">
                                        <div class="row">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" maxlength="100" name="nome_setor" id="nome_setor" required />
                                                </div>
                                            </div>
                                        </div>
