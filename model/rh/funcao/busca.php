...
$sql = mysqli_query($conexao, "select * from funcao where nome_funcao like '%".$valor."%' order by nome_funcao asc limit $inicio, $quantidade"); // Procura titulos no banco relacionados ao valor
